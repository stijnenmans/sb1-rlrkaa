    ...
    <section className="py-24 bg-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-secondary via-accent to-accent bg-clip-text text-transparent">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {/* Left side - Map */}
            <div className="h-[200px] md:h-[400px] bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 overflow-hidden">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 md:p-6 border border-white/10 flex flex-col min-h-[200px] md:h-[400px]">
              <div className="flex-1 space-y-4">
                ...
                <div>
                  ...
                  <select
                    className="w-full bg-white/5 border border-white/10 rounded-xl py-2.5 px-4 text-white placeholder-gray-400 focus:ring-2 focus:ring-accent focus:border-transparent"
                    value={filters.city}
